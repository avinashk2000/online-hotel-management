		...
		<div class="container-fluid">
			...
			<div class="row" style="background-image: url('image/bgback.jpg'); background-size: 100% 100%;">
				...
				<div class="col-sm-8 col-xs-8 col-lg-8">
					<br/>
					<p class="display-4 text-center text-light" style="text-shadow: 3px 3px 4px cyan; font-size: 30px;font-family: Courier New;">Login Form</p>	
					<form action="code/logindb.php" method="post">
						<div class="form-row">
		                    <div class="col-12">
		                    	<br/>
		                        <label class="text-light" style="text-shadow: 3px 3px 4px cyan; font-family: Courier New; font-size: 30px;">Name</label>
		                        <input type="text" name="uname" class="form-control" style="background-color: transparent; color: white;text-shadow: 2px 2px 2px red; font-family: Courier New; font-size: 30px;"/>
		                    </div>
			            </div>
			            <div class="form-row">
		                    <div class="col-12">
		                        ...
		                        <input type="email" name="email" class="form-control" style="background-color: transparent; text-shadow: 2px 2px 2px red; color: white; font-family: Courier New;font-size: 26px;"/>
		                    </div>
			            </div>
		                <div class="form-row">
		                    <div class="col-12">
		                        ...
		                        <input type="password" class="form-control" name="pass" style="background-color: transparent; color: white; text-shadow: 2px 2px 2px red; font-family: Courier New; font-size: 24px;"></input>
			                </div>
			            </div>
			            <div class="form-row">
			                <div class="col-12">
